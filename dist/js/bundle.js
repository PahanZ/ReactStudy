...
var _correctDate = __webpack_require__(21);

var _correctDate2 = _interopRequireDefault(_correctDate);

var _getData = __webpack_require__(54);
...
var _Cards = __webpack_require__(57);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = { carriers: _getData2.default.flights };
  ...
  _createClass(App, [{
    ...
    value: function onChange(event) {
      if (event.target.value === 'All Carrier') {
        this.setState({ carriers: _getData2.default.flights });
      } else {
        var newState = _getData2.default.flights.filter(function (element) {
          return element.carrier === event.target.value ? element : null;
        });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Select2.default, {
            data: _getData2.default.flights,
            title: 'All Carrier',
            onChange: this.onChange
          })
        ),
        _react2.default.createElement(_Cards2.default, { data: this.state.carriers, correctdate: _correctDate2.default })
      );
    }
  }]);
