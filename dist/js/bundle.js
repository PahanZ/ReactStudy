...
var _getData = __webpack_require__(74);
...
var reducer = function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _getData2.default;
  var action = arguments[1];

  if (action.type === 'changeStore') {
    state = [].concat(_toConsumableArray(action.payload));
  }
  return state;
};
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(23),B=__webpack_require__(3),C=__webpack_require__(2),ba=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),fa=__webpack_require__(27),ia=__webpack_require__(28),D=__webpack_require__(5);
...
var _correctDate = __webpack_require__(29);

var _correctDate2 = _interopRequireDefault(_correctDate);
...
// const filter = (carriers, firstStoreUpload) => {
...
var App = function App(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Cards2.default, { data: state, correctdate: _correctDate2.default })
  );
};
...
exports.default = function (props) {
  ...
  var items = Object.keys(obj).map(function (element, i) {
    return _react2.default.createElement(
      "option",
      { key: i.toString() },
      element
...
exports.default = function (props) {
  var card = props.data.map(function (element, i) {
    return _react2.default.createElement(
      'div',
      { key: i.toString(), className: 'card' },
      _react2.default.createElement(
        'div',
        { key: 'Carrier' + element.id },
        'Carrier: ' + element.carrier
      ),
      _react2.default.createElement(
        'div',
        { key: 'From' + element.id },
        'From: ' + element.direction.from
      ),
      _react2.default.createElement(
        'div',
        { key: 'To' + element.id },
        'To: ' + element.direction.to
      ),
      _react2.default.createElement(
        'div',
        { key: 'Arrival' + element.id },
        'Arrival: ' + (0, _correctDate2.default)(element.arrival)
      ),
      _react2.default.createElement(
        'div',
        { key: 'Departure' + element.id },
        'Departure: ' + (0, _correctDate2.default)(element.departure)
      )
    );
  });
  return card;
...
var info = getData(_data2.default);
